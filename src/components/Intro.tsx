      ...
      <div className="w-full max-w-xs">
        ...
        >
          ...
          <div className="font-serif-en italic text-xs tracking-[0.15em] text-warm-muted mb-12">
            — originium decompression protocol —
          </div>
        </motion.div>
        ...
        >
          <h1 className="font-serif-en text-5xl font-normal tracking-[0.08em] leading-tight text-white mb-4 text-center w-full">
            ORIGINIUM
          </h1>
          <div className="mb-12">
            <p className="font-sans text-xl font-medium tracking-[0.25em] text-warm-white">
              罗德岛干员人格测试
            </p>
            <p className="font-serif-en italic text-xs tracking-[0.15em] text-warm-dim mt-3">
              Assimilated Universe
            </p>
          </div>

          <p className="font-serif-cn text-sm leading-[1.9] text-warm-muted max-w-[280px] mx-auto mb-2">
            源石计划在晶体深处折叠出一个内化宇宙。<br />
            一段信号在其中穿行了一万三千年<br />
            穿过每一次天灾、每一场战争、<br />
            每一个文明的终焉。<br />
            <em className="font-serif-en italic text-warm-dim">从未衰减。从未被回应。</em>
          </p>
        ...
        >
          <button
            onClick={onStart}
            className="inline-block px-14 py-4 bg-white text-deep-900 font-serif-cn text-base tracking-[0.3em] cursor-pointer transition-all duration-300 hover:bg-warm-white active:scale-[0.97]"
          >
            开 始 扫 描
          </button>
        </motion.div>
        ...
        >
          <p className="font-serif-en italic text-xs tracking-[0.15em] text-warm-dim/50">
            32 operators · 20 questions · 5 min
          </p>
          <p className="font-serif-en italic text-xs tracking-[0.1em] text-warm-dim">
            ████ · 信号稳定 · 终端待命
          </p>
          <div className="flex flex-col items-center gap-3 mt-6">
            <div className="flex items-center gap-2 opacity-40">
              <span className="text-warm-dim/30 text-[8px]">⬡</span>
              <span className="w-8 h-[1px] bg-gradient-to-r from-transparent via-warm-dim/20 to-transparent"></span>
              <span className="text-warm-dim/30 text-[8px]">⬡</span>
            </div>
            <button
              onClick={onRandom}
              className="group relative font-serif-cn text-xs tracking-[0.2em] text-warm-dim/60 cursor-pointer transition-all duration-200 hover:text-warm-muted bg-transparent px-5 py-2"
            >
              ...
              <span className="absolute inset-0 border border-white/5 group-hover:border-white/10 transition-colors" />
              <span className="absolute top-0 left-0 w-2 h-2 border-l border-t border-warm-dim/20 group-hover:border-warm-dim/40 transition-colors" />
              <span className="absolute top-0 right-0 w-2 h-2 border-r border-t border-warm-dim/20 group-hover:border-warm-dim/40 transition-colors" />
              <span className="absolute bottom-0 left-0 w-2 h-2 border-l border-b border-warm-dim/20 group-hover:border-warm-dim/40 transition-colors" />
              <span className="absolute bottom-0 right-0 w-2 h-2 border-r border-b border-warm-dim/20 group-hover:border-warm-dim/40 transition-colors" />
            </button>
            <button
              onClick={onShowAll}
              className="group relative font-mono text-[0.5rem] tracking-[0.25em] text-warm-dim/30 cursor-pointer transition-all duration-200 hover:text-warm-dim/60 bg-transparent px-4 py-1.5"
            >
              <span className="relative z-10 flex items-center gap-2">
                <span className="text-[5px] opacity-20">◇</span>
                DEBUG · 全部档案
                <span className="text-[5px] opacity-20">◇</span>
              </span>
              <span className="absolute inset-0 border border-white/[0.03] group-hover:border-white/[0.08] transition-colors" />
            </button>
          </div>
        </motion.div>
      </div>
